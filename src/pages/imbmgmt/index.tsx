...
const sections = [
  { name: 'Live Ops', description: 'For managing the Live Operations', link: '/imbmgmt/liveops/overview' },
  { name: 'Shadow Mode', description: 'For running your strategies in shadow mode, to emulate live operations but without sending real bids/offers to the ISO', link: '/imbmgmt/shadow/overview' },
  { name: 'Simulation', description: 'For running backtests, forward-projections, and "what if" scenarios', link: '/imbmgmt/sim/overview' },
  { name: 'Strategy Dev', description: 'For developing and optimizing strategies', link: '/imbmgmt/stratdev/overview' }
]

const ImbalanceMgmtPage: React.FC = () => {
...
export default ImbalanceMgmtPage